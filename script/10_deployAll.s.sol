...
contract DeployAllScript is Script {
    ...
    bytes4[] private router_selectors = new bytes4[](3);
    ...
    function run() public {
        ...
        router_selectors[0] = Router(address(0)).setRouterUtil.selector;
        router_selectors[1] = Router(address(0)).setKyberRouter.selector;
        router_selectors[2] = Router(address(0)).setPendleRouter.selector;
    ...
    function deployForTest(
        ...
        pendleRouter = inputData._pendleRouter;
