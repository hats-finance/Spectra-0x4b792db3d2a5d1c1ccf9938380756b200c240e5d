...
interface IRouter {
    ...
    /**
     * @dev Getter for the Pendle Router
     * @return The address of the Pendle Router
     */
    ...
    /**
     * @dev Setter for the Pendle Router
     * @param _pendleRouter The new address of the Pendle Router
     */
    function setPendleRouter(address _pendleRouter) external;
