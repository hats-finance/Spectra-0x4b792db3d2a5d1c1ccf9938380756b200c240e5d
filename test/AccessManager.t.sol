...
contract AccessManagerSystem is Test {
    ...
    address public pendleRouterAddr = 0x0000000000000000000000000000000000937be8;
    ...
    function testRouterAccess() public {
        ...
        assertEq(router.getPendleRouter(), pendleRouterAddr);
